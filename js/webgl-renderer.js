...
class WebGLRenderer {
    ...
    createMatrix(x, y, width, height, rotation, canvasWidth, canvasHeight) {
    ...
    drawRectangle(obj, viewport) {
        ...
        gl.uniform1f(program.uniforms.u_radius, (obj.cornerRadius || 0) * viewport.zoom);
