...
class GuideManager {
    ...
    createRulerElements() {
        ...
        // Get canvas contexts
        this.hRulerCanvas = this.hRuler.querySelector('.ruler-canvas');
        this.vRulerCanvas = this.vRuler.querySelector('.ruler-canvas');
    ...
    bindEvents() {
        ...
        this.hRuler?.addEventListener('dblclick', (e) => {
        ...
        this.vRuler?.addEventListener('dblclick', (e) => {
    ...
    resize() {
        if (!this.hRulerCanvas || !this.vRulerCanvas) return;
    ...
    render() {
        ...
        this.hRuler.style.display = 'block';
        this.vRuler.style.display = 'block';
        this.cornerBox.style.display = 'block';
    ...
    addGuide(orientation, position) {
        const guide = { id: Utils.generateId(), position };
    ...
    getSnapPosition(x, y, width = 0, height = 0) {
